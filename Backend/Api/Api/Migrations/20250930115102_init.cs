        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ActivityOccurrences_Places_PlaceId",
                        column: x => x.PlaceId,
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    ActivityOccurrenceId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    UserId = table.Column<string>(type: "nvarchar(450)", nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Activities_IsActive_Environment",
                table: "Activities",
                columns: new[] { "IsActive", "Environment" });

            migrationBuilder.CreateIndex(
                name: "IX_ActivityOccurrences_ActivityId_StartUtc",
                table: "ActivityOccurrences",
                columns: new[] { "ActivityId", "StartUtc" });

            migrationBuilder.CreateIndex(
                name: "IX_ActivityOccurrences_PlaceId_StartUtc",
                table: "ActivityOccurrences",
                columns: new[] { "PlaceId", "StartUtc" });

            migrationBuilder.CreateIndex(
                name: "IX_ActivityOccurrences_StartUtc_EndUtc",
                table: "ActivityOccurrences",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Places_IsActive_Environment",
                table: "Places",
                columns: new[] { "IsActive", "Environment" });
